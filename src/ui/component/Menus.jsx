...
/**
 * Renders the Menus component with the provided children.
 *
 * @param {Object} children - The children elements to render within the Menus component.
 * @return {JSX.Element} The rendered Menus component.
 */
...
/**
 * Preventing event propagation, getting button's bounding rectangle,
 * setting position of the menu list, opening or closing menu based on its current state.
 *
...
/**
 * Closes the menu by setting the openId state to an empty string.
 *
 * @return {void}
 */
 ...
 *
 * @param {Object} children - The children elements to be rendered inside the button
 * @param {Object} icon - The icon element to be displayed in the button
 * @param {Function} onClick - The function to be executed on button click
 * @return {JSX.Element} The styled button component with children and icon
 */
function Button({ children, icon, onClick }) {
  const { close } = useContext(MenusContext); // Accessing context for managing menus

  /**
   * Executing the onClick function and closing the menu.
   *

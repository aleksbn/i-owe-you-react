...
/**
 * Render a modal component with the provided children.
 *
 * @param {ReactNode} children - The content to be displayed inside the modal
 * @return {ReactNode} The modal component rendered with the children
 */
 ...
 *
 * @param {string} opens - The name of the modal window to open
 * @param {ReactNode} children - The child components
 * @return {ReactElement} The cloned element with onClick handler to open the modal
 */
...
/**
 * Render a modal window based on the provided name and children.
 *
 * @param {string} name - The name of the modal window
 * @param {ReactNode} children - The content to be displayed inside the modal
 * @return {ReactNode} The modal window rendered into a different DOM node
 */
